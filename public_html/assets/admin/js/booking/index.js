...
function genViewDetail(booking)
{
	...
	html += '<hr/>';
	html += '<div class="row">'
		html += '<div style="margin-bottom: 30px" class="col-md-6">';
			...
			html += '</h5>';
			html += '<h5 class="mw-left">';
			html += 'หมายเหตุ : '+((booking.comment) ? booking.comment : '');
			html += '</h5>';
			html += '<h5 class="mw-left">';
			...
			html += '<div class="col-md-6">'
				html += '<form id="form_submit_save_booking" method="POST" action="#">'
					html += '<h4>รายละเอียด</h4>';
					html += '<input type="hidden" name="booking_key" value="'+booking.key+'">';
					html += '<div class="row">';
					html += 	'<div class="col-md-4">';
					html += 		'ชื่อผู้ติดต่อ : ';
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.person_name+'" id="person_name" name="person_name" style="margin-bottom:4px;" >';
					html += 	'</div>';
					html += '</div>';
					...
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.person_mobile+'" id="person_mobile" name="person_mobile" style="margin-bottom:4px;" >';
					html += 	'</div>';
					html += '</div>';

					html += '<div class="row">';
					html += 	'<div class="col-md-4">';
					html += 		'รหัสบริษัทลูกค้า : ';
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.customer_key+'" id="customer_key" name="customer_key" style="margin-bottom:4px;" >';
					html += 	'</div>';
					html += '</div>';

					html += '<div class="row">';
					html += 	'<div class="col-md-4">';
					html += 		'ชื่อบริษัทลูกค้า : ';
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.customer_name+'" id="customer_name" name="customer_name" style="margin-bottom:4px;" >';
					html += 	'</div>';
					html += '</div>';
					...
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.address+'" id="address" name="address" style="margin-bottom:4px;" placeholder="address">';
					html += 	'</div>';
					html += '</div>';
					...
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.district+'" id="district" name="district" style="margin-bottom:4px;" placeholder="district">';
					html += 	'</div>';
					html += '</div>';
					...
					html += 	'</div>';
					html += 	'<div class="col-md-6">';
					html += 		'<input type="text" class="form-control input_booking_keyup" value="'+booking.province+'" id="province" name="province" style="margin-bottom:4px;" placeholder="province">';
					html += 	'</div>';
					html += '</div>';
				html += '</form>';
			html += '</div>';
...
$(document).on('keyup','.input_booking_keyup',function(e){
	var booking_key = $(this).attr('booking_key');
	var col_name = $(this).attr('col_name');
	var value = $(this).val(); 
	var form = $('#form_submit_save_booking');
	$.ajax({
		url: 'http://af1express.com/api/ajax/edit_booking.php',
		type: 'POST',
